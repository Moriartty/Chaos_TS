...
actions.loadTrackType = function (pageNo, pageSize) { return function (dispatch, getState) {
    ...
    return fetch_1.default.post(const_1.default.TRACK_TYPE_GETALL_BYPAGE, { data: dataParam, page: pageParam }).then(function (data) {
...
actions.loadAllTrackType = function () { return function (dispatch) {
    return fetch_1.default.get(const_1.default.TRACK_TYPE_GETALL, {}).then(function (data) {
...
actions.addOrEditTrackType = function (data) { return function (dispatch) {
    fetch_1.default.post(const_1.default.TRACK_TYPE_SAVE, data).then(function () {
...
actions.deleteTrack = function (key) { return function (dispatch) {
    fetch_1.default.get(const_1.default.TRACK_TYPE_REMOVE + '/' + key, {}).then(function () {
        antd_1.message.success('操作成功');
        dispatch(actions.loadTrackType());
    }).catch(function (err) {
        antd_1.message.warn('操作失败');
...
actions.batchDeleteTrack = function (keys) {
    fetch_1.default.get(const_1.default.TRACK_TYPE_BATCHREMOVE, { ids: keys.join(',') }).then(function (data) {
        antd_1.message.success('操作成功');
    }).catch(function (err) {
        antd_1.message.warn('操作失败');
    });
...
actions.loadTrackDemand = function (pageNo, pageSize) { return function (dispatch, getState) {
    ...
    return fetch_1.default.post(const_1.default.TRACK_DEMAND_GETALL_BYPAGE, { data: dataParam, page: pageParam }).then(function (data) {
...
actions.loadAllTrackDemand = function () { return function (dispatch) {
    return fetch_1.default.get(const_1.default.TRACK_DEMAND_GETALL, {}).then(function (data) {
...
actions.addOrEditTrackDemand = function (data) { return function (dispatch) {
    fetch_1.default.post(const_1.default.TRACK_DEMAND_SAVE, data).then(function () {
        antd_1.message.success('操作成功');
...
actions.deleteTrackDemand = function (key) { return function (dispatch) {
    fetch_1.default.get(const_1.default.TRACK_DEMAND_REMOVE + '/' + key, {}).then(function () {
        antd_1.message.success('操作成功');
        dispatch(actions.loadTrackDemand());
    }).catch(function (err) {
        antd_1.message.warn('操作失败');
...
actions.batchDeleteTrackDemand = function (keys) { return function () {
    fetch_1.default.get(const_1.default.TRACK_DEMAND_BATCHREMOVE, { ids: keys.join(',') }).then(function (data) {
        antd_1.message.success('操作成功');
    }).catch(function (err) {
        antd_1.message.warn('操作失败');
    });
...
actions.verifyTrackDemand = function (state, data) { return function (dispatch) {
    ...
    fetch_1.default.post(const_1.default.TRACK_DEMAND_VERIFY, { map: params }).then(function () {
...
actions.loadTrackInfo = function (pageNo, pageSize) { return function (dispatch, getState) {
    ...
    return fetch_1.default.post(const_1.default.TRACK_INFO_GETALL_BYPAGE, { data: dataParam, page: pageParam }).then(function (data) {
...
actions.addOrEditTrackInfo = function (data) { return function (dispatch) {
    fetch_1.default.post(const_1.default.TRACK_INFO_SAVE, data).then(function () {
        antd_1.message.success('操作成功');
 ...
 * @returns {Function}
 */
action.loadList = function () { return function (dispatch) { return fetch_1.default.get('/role').then(function (list) {
...
function loadMenuTree() {
    return function (dispatch) {
        return fetch_1.default.get('/menu').then(function (data) {
            var treeData = [
...
function selectRole(role) {
    return function (dispatch) {
        ...
        return fetch_1.default.get('/role/auth', {
            id: role.id
        }).then(function (data) {
            var roleAuth = [];
...
function updateRoleMenu(roleId, data) {
    return function (dispatch) {
        return fetch_1.default.post('/role/auth-update', {
            id: roleId,
...
function addRole(data) {
    return function (dispatch) {
        return fetch_1.default.post('/role/create', {
            name: data.name,
            desc: data.desc
        });
    };
...
function deleteRole(id) {
    return function (dispatch) {
        return fetch_1.default.post('/role/delete', {
            id: id
        }).then(function () {
            // 取消当前选择的角色
...
Object.defineProperty(exports, "__esModule", { value: true });
var evan_you_1 = __importDefault(__webpack_require__(874));
...
var Overlay_1 = __importDefault(__webpack_require__(875));
exports.Overlay = Overlay_1.default;
var PotentialError_1 = __importDefault(__webpack_require__(124));
exports.PotentialError = PotentialError_1.default;
var RegionSelector_1 = __importDefault(__webpack_require__(549));
exports.RegionSelector = RegionSelector_1.default;
var CircleBtn_1 = __importDefault(__webpack_require__(878));
