...
actions.loadFieldsData = function (pageNo, pageSize) { return function (dispatch, getState) {
    ...
    var page = state.page;
    var params = __assign({}, searchParams, { currentPage: pageNo || page.pageNo, pageSize: pageSize || page.pageSize });
    fetch_1.default.get(const_1.default.FIELDTRANS_GETALL, params).then(function (data) {
        ...
        dispatch(app_1.default.setSearchParamsInLocalStorage(params, 'FIELDTRANS_SEARCHPARAMS_CHANGE'));
    });
}; };
/**
 * 新增trackDemand
...
Object.defineProperty(exports, "__esModule", { value: true });
var index_1 = __webpack_require__(856);
var react_redux_1 = __webpack_require__(78);
var fieldTranslation_1 = __importDefault(__webpack_require__(1560));
var antd_1 = __webpack_require__(43);
...
var Table = /** @class */ (function (_super) {
    ...
    Table.prototype.render = function () {
        var _this = this;
        var _a = this.props, loading = _a.loading, list = _a.list, pageNo = _a.pageNo, dataCount = _a.dataCount, searchParams = _a.searchParams, onPageChange = _a.onPageChange, onPageSizeChange = _a.onPageSizeChange, isBatchDelState = _a.isBatchDelState, operations = _a.operations, systemList = _a.systemList, langList = _a.langList;
        ...
        this.columns = [
            ...
            { title: 'system', dataIndex: 'systemId', render: function (value) {
                    return systemList.find(function (o) { return o.oid === value; }).name;
                } },
            { title: 'language', dataIndex: 'language', render: function (value) {
                    return langList.find(function (o) { return o.id === value; }).name;
                } },
        ];
        if (isBatchDelState) {
            rowSelection = {
...
var TableComp = react_redux_1.connect(function (state) {
    var langList = state['app'].langList;
    var operations = state.app.menuObj['systemConfig/fieldTranslation'].functions;
    var _a = state['fieldTranslation'], loading = _a.loading, list = _a.list, page = _a.page, searchParams = _a.searchParams, systemList = _a.systemList;
    return __assign({ loading: loading, list: list }, page, { searchParams: searchParams, operations: operations, langList: langList, systemList: systemList });
...
var SearchForm = antd_1.Form.create({
    ...
    return (React.createElement(antd_1.Form, null,
        ...
        React.createElement(ExFormItem_1.default, { type: 'select', list: systemList.map(function (o) {
                return {
                    id: o.oid,
                    name: o.name
                };
            }), label: 'system', name: 'systemId', getFieldDecorator: getFieldDecorator }),
        React.createElement(ExFormItem_1.default, { type: 'select', list: langList, label: 'language', name: 'language', getFieldDecorator: getFieldDecorator })));
});
var SearchModal = /** @class */ (function (_super) {
    ...
    SearchModal.prototype.render = function () {
        var _a = this.props, show = _a.show, onClose = _a.onClose, searchParams = _a.searchParams, systemList = _a.systemList, langList = _a.langList;
        return (React.createElement(ExModal_1.default, { visible: show, title: '查询条件', onCancel: onClose, onOk: this.handleSave },
            React.createElement(SearchForm, { ref: this.saveFormRef, searchParams: searchParams, systemList: systemList, langList: langList })));
    };
    return SearchModal;
}(React.Component));
var SearchModalComp = react_redux_1.connect(function (state) {
    var langList = state['app'].langList;
    var _a = state['fieldTranslation'], searchParams = _a.searchParams, systemList = _a.systemList;
    return { searchParams: searchParams, systemList: systemList, langList: langList };
}, null)(SearchModal);
...
var EditModalComp = react_redux_1.connect(function (state) {
    var langList = state['app'].langList;
    var _a = state['fieldTranslation'], editModalShow = _a.editModalShow, editData = _a.editData, editModalLoading = _a.editModalLoading, systemList = _a.systemList;
    ...
    onSubmit: function (data) {
        ...
        if (!data.id) {
            if (Object.keys(str).length > 1) {
                ...
                dispatch(fieldTranslation_1.default.batchCreate(arr_1));
            }
            else {
            ...
            dispatch(fieldTranslation_1.default.edit({
                systemId: data.systemId,
                language: data.language,
                strKey: Object.keys(str)[0],
                strVal: str[Object.keys(str)[0]]
...
var Table_1 = __importDefault(__webpack_require__(1581));
var Toolbar_1 = __importDefault(__webpack_require__(1559));
var SearchModal_1 = __importDefault(__webpack_require__(1582));
var antd_1 = __webpack_require__(43);
var EditModal_1 = __importDefault(__webpack_require__(1583));
var react_intl_1 = __webpack_require__(160);
var React = __importStar(__webpack_require__(0));
...
var FieldTranslationComp = react_redux_1.connect(function (state) {
    ...
    onSearch: function (params) {
        console.log(params);
        dispatch({ type: 'FIELDTRANS_SEARCHPARAMS_CHANGE', params: params });
