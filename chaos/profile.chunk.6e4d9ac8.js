 ...
 * @returns {Function}
 */
action.loadRoleList = function () { return function (dispatch) { return fetch_1.default.get(const_1.default.ROLE_ALLDATA_LOAD, {}).then(function (list) {
...
var profile_1 = __importDefault(__webpack_require__(1597));
        ...
        return (React.createElement(antd_1.Form, { onSubmit: this.submit },
            React.createElement("fieldset", null,
                ...
                React.createElement("div", { style: { maxWidth: 800 } },
                    React.createElement(index_1.ExFormItem, { label: '\u5E10\u6237\u540D', name: 'username', initialValue: info.username, getFieldDecorator: getFieldDecorator }),
                    React.createElement(index_1.ExFormItem, { label: "\u59D3\u540D", name: 'name', initialValue: info.name || '', getFieldDecorator: getFieldDecorator }),
                    React.createElement(index_1.ExFormItem, { label: "\u6027\u522B", type: "radio", name: "sex", initialValue: info.sex, list: [{ id: 0, name: '男' }, { id: 1, name: '女' }], getFieldDecorator: getFieldDecorator }),
                    ...
                    React.createElement(index_1.ExFormItem, { label: "\u7C4D\u8D2F", name: "birthplace", initialValue: info.birthplace, getFieldDecorator: getFieldDecorator }),
                    React.createElement(index_1.ExFormItem, { label: "\u7EC4\u7EC7", type: "static", initialValue: info.org }),
                    React.createElement(index_1.ExFormItem, { label: "\u7528\u6237\u89D2\u8272", type: 'select', name: 'role', list: roleList.map(function (o) { return ({ id: o.rid, name: o.name }); }), getFieldDecorator: getFieldDecorator }))),
            React.createElement("fieldset", null,
                React.createElement("legend", null,
                    React.createElement(antd_1.Icon, { type: "tag-o" }),
                    " \u8054\u7CFB\u65B9\u5F0F"),
                React.createElement("div", { style: { maxWidth: 800 } },
                    ...
                    React.createElement(index_1.ExFormItem, { label: "\u7535\u8BDD", name: "phone", initialValue: info.phone, getFieldDecorator: getFieldDecorator }))),
