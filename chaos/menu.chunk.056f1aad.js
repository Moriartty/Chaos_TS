...
var menu_1 = __importDefault(__webpack_require__(1558));
...
var EditForm = antd_1.Form.create({
    ...
    return (React.createElement(antd_1.Form, null,
        ...
        type === 1 && (React.createElement(index_1.ExFormItem, { label: "SystemUrl", name: 'systemUrl', initialValue: data.systemUrl, placeholder: '\u8BF7\u586B\u5199\u8BE5\u7CFB\u7EDF\u8BBF\u95EE\u7684url', getFieldDecorator: getFieldDecorator })),
        React.createElement(index_1.ExFormItem, { label: "\u63CF\u8FF0", type: "textarea", name: "description", initialValue: data.description, getFieldDecorator: getFieldDecorator }),
...
var EditForm = antd_1.Form.create({
    mapPropsToFields: function (props) {
        ...
        return {
            ...
            systemUrl: antd_1.Form.createFormField({ value: params.systemUrl }),
    ...
    return (React.createElement(antd_1.Form, null,
        ...
        React.createElement(index_1.ExFormItem, { label: 'SystemUrl', name: 'systemUrl', getFieldDecorator: getFieldDecorator }),
        React.createElement(index_1.ExFormItem, { type: 'textarea', label: 'Description', name: 'description', getFieldDecorator: getFieldDecorator })));
});
...
var EditModal_1 = __importDefault(__webpack_require__(1567));
var EditSystemModal_1 = __importDefault(__webpack_require__(1568));
// import Toolbar from './Toolbar';
var Toolbar_1 = __importDefault(__webpack_require__(1559));
var Table_1 = __importDefault(__webpack_require__(1569));
var React = __importStar(__webpack_require__(0));
