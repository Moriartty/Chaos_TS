...
var track_1 = __importDefault(__webpack_require__(1555));
...
var SearchForm = antd_1.Form.create({
    mapPropsToFields: function (props) {
        ...
        return {
            eventId: antd_1.Form.createFormField({ value: params.eventId }),
            eventType: antd_1.Form.createFormField({ value: params.eventType }),
            trackType: antd_1.Form.createFormField({ value: params.trackType }),
        };
    }
})(function (props) {
    var form = props.form, eventTypeCodes = props.eventTypeCodes, trackType_allData = props.trackType_allData;
    var getFieldDecorator = form.getFieldDecorator;
    return (React.createElement(antd_1.Form, null,
        React.createElement(ExFormItem_1.default, { label: 'EventId', name: 'eventId', getFieldDecorator: getFieldDecorator }),
        React.createElement(ExFormItem_1.default, { type: 'select', list: eventTypeCodes, label: 'EventType', name: 'eventType', getFieldDecorator: getFieldDecorator }),
...
var SearchModal = /** @class */ (function (_super) {
    ...
    SearchModal.prototype.render = function () {
        var _a = this.props, show = _a.show, onClose = _a.onClose, searchParams = _a.searchParams, eventTypeCodes = _a.eventTypeCodes, trackType_allData = _a.trackType_allData;
        return (React.createElement(ExModal_1.default, { visible: show, title: '查询条件', onCancel: onClose, onOk: this.handleSave },
            React.createElement(SearchForm, { ref: this.saveFormRef, searchParams: searchParams, eventTypeCodes: eventTypeCodes, trackType_allData: trackType_allData })));
    };
    return SearchModal;
}(React.Component));
var SearchModalComp = react_redux_1.connect(function (state) {
    var _a = state['track'], searchParams = _a.trackInfo_searchParams, eventTypeCodes = _a.eventTypeCodes, trackType_allData = _a.trackType_allData;
    return { searchParams: searchParams, eventTypeCodes: eventTypeCodes, trackType_allData: trackType_allData };
}, null)(SearchModal);
...
var EditForm = antd_1.Form.create({
    ...
    mapPropsToFields: function (props) {
        ...
        var eventTypeCode = eventTypeCodes.find(function (o) { return o.name == editData.eventType; });
        return {
...
var Table_1 = __importDefault(__webpack_require__(1584));
var Toolbar_1 = __importDefault(__webpack_require__(1559));
var SearchModal_1 = __importDefault(__webpack_require__(1585));
var antd_1 = __webpack_require__(43);
var EditModal_1 = __importDefault(__webpack_require__(1586));
var React = __importStar(__webpack_require__(0));
