        ...
        if (isBatchDelState) {
            ...
            this.columns.push({
                title: 'Action', dataIndex: '', key: '', render: function (data) {
                    return (React.createElement("span", null, ~~data.state === 0 && operations.indexOf('trackDemand_operation_verify') > -1 &&
                        React.createElement("a", { href: 'javascript:;', onClick: _this.props.handleVerify.bind(_this, data) }, "\u5BA1\u6838")));
                }
            });
        }
...
var SearchModalComp = react_redux_1.connect(function (state) {
    var searchParams = state['track'].trackDemand_searchParams;
...
var EditForm = antd_1.Form.create({
    ...
    return (React.createElement(antd_1.Form, null,
        ...
        React.createElement(index_1.ExFormItem, { name: 'trackType', label: 'trackType', type: 'select', list: trackType_allData.map(function (o) { return ({ id: o.name, name: o.name }); }), getFieldDecorator: getFieldDecorator, required: true }),
...
var TrackDemandMgr = /** @class */ (function (_super) {
    ...
    function TrackDemandMgr(props) {
        ...
        _this.handleToggle = function () {
            _this.props.onViewStateChange((~~_this.props.viewState === 0) ? 1 : 0);
        };
        _this.state = {
    ...
    TrackDemandMgr.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'trackDemadContainer' },
            React.createElement(Toolbar_1.default, { onRefresh: onRefresh }, this.state.isBatchDelState ? (React.createElement(React.Fragment, null,
                ...
                React.createElement(antd_1.Button, { type: 'primary', onClick: this.handleToggle, style: { marginLeft: 20 } }, ~~viewState === 1 ? '返回普通查看' : '查看我的待审核')))),
