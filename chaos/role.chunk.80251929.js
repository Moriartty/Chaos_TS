...
var role_1 = __importDefault(__webpack_require__(1557));
...
var EditForm = antd_1.Form.create()(function (props) {
    ...
    return (React.createElement(antd_1.Form, null,
        ...
        React.createElement(ExFormItem_1.default, { label: "\u63CF\u8FF0", type: "textarea", name: "desc", initialValue: data.desc, placeholder: "\u8F93\u5165\u5BF9\u89D2\u8272\u7684\u63CF\u8FF0...", getFieldDecorator: getFieldDecorator }),
...
var antd_1 = __webpack_require__(43);
var EditModal_1 = __importDefault(__webpack_require__(1562));
var RoleList_1 = __importDefault(__webpack_require__(1563));
var RoleMenu_1 = __importDefault(__webpack_require__(1564));
var react_intl_1 = __webpack_require__(160);
var React = __importStar(__webpack_require__(0));
            ...
            role.rid ? (React.createElement("div", { className: "role-right" },
                React.createElement("div", { className: "header" },
                    ...
                    !['系统管理员'].include(role.name) && (React.createElement("div", { className: "actions" },
                        ...
                        operations.indexOf('role_operation_delete') >= 0 && (React.createElement(antd_1.Popconfirm, { placement: "left", title: "\u786E\u5B9A\u5220\u9664\u8BE5\u89D2\u8272\uFF1F", onConfirm: onDelete.bind(this, role.rid) },
