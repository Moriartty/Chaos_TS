...
class SubPage extends React.Component<CompProps> {
    ...
    handleShow = () => {
        // open
        let ele:HTMLBodyElement = document.querySelector('.ant-tabs-tabpane-active')||document.querySelector('.main-page');
        // 滚动条回到顶部并隐藏
            ...
            <div className="sub-page display-flex flex-column" style={{display: show ? '' : 'none' }}>
                <div className="hd">
                    <div className="actions">
                        <Button type={'primary'} onClick={onClose} icon="rollback" href=''>返回</Button>
                    </div>
